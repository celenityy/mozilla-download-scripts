...
"${ROOT}" "${CHMOD}" -R -v 644 "${FIREFOX_DIR}"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}/browser"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}/browser/chrome"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}/browser/chrome/icons"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}/browser/chrome/icons/default"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}/defaults"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}/defaults/pref"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}/firefox"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}/firefox-bin"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}/fonts"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}/glxtest"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}/icons"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}/updater"
"${ROOT}" "${CHMOD}" -v 755 "${FIREFOX_DIR}/vaapitest"
